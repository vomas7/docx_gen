...
class ElementProxy:
    ...
    common type of class in python-ui_objects other than custom element (oxml) classes.
    """

    def __init__(self, element, parent: t.ProvidesXmlPart | None = None):
